...
use oqqwall_rust_drivers::napcat::{
    ...
    UserNotificationTemplate, normalize_agent_command_config, update_group_user_notification_settings,
...
type SendSuccessReplyVariableInfo = UserNotificationVariableInfo;
...
async fn webview_update_user_notification_settings(
    ...
    let config = UserNotificationSettings {
        ...
        tag_value_maps: normalize_tag_value_mapping_groups(
            if req.tag_value_maps.is_empty() {
                req.tag_value_map
                    .into_iter()
...
fn send_success_reply_variables() -> Vec<SendSuccessReplyVariableInfo> {
    vec![
        SendSuccessReplyVariableInfo {
            key: "code",
            label: "显示编号",
        ...
        SendSuccessReplyVariableInfo {
            key: "external_code",
            label: "外部编号",
            description: "投稿对外展示的编号。",
            example: "<external_code>",
        },
        SendSuccessReplyVariableInfo {
            key: "internal_code",
            label: "内部编号",
            description: "审核流程里的内部编号。",
            example: "<internal_code>",
        },
        SendSuccessReplyVariableInfo {
            key: "post_id",
            label: "稿件 ID",
            description: "Rust 内部 post_id 数字。",
            example: "<post_id>",
        },
        SendSuccessReplyVariableInfo {
            key: "review_id",
            label: "审核 ID",
            description: "审核项对应的 review_id 数字。",
            example: "<review_id>",
        },
        SendSuccessReplyVariableInfo {
            key: "group_id",
            label: "组号",
            description: "稿件所属 group_id。",
            example: "<group_id>",
        },
        SendSuccessReplyVariableInfo {
            key: "sender_id",
            label: "投稿人 QQ",
            description: "系统识别出的投稿人 user_id。",
            example: "<sender_id>",
        },
        SendSuccessReplyVariableInfo {
            key: "account_id",
            label: "发送账号",
            description: "实际执行发送的账号 QQ。",
            example: "<account_id>",
        },
        SendSuccessReplyVariableInfo {
            key: "send_time",
            label: "发送时间",
            description: "按当前系统时区配置格式化的发送时间。",
            example: "<send_time>",
        },
        SendSuccessReplyVariableInfo {
            key: "send_timestamp_ms",
            label: "发送时间戳",
            description: "发送成功时的毫秒时间戳。",
            example: "<send_timestamp_ms>",
        },
        SendSuccessReplyVariableInfo {
            key: "reviewer",
            label: "审核人",
            description: "最后一次处理该稿件的操作人，常见于 webview 用户名。",
            example: "<reviewer>",
        },
        SendSuccessReplyVariableInfo {
            key: "reviewed_at",
            label: "审核时间",
            description: "最后一次记录审核决策的时间。",
            example: "<reviewed_at>",
        },
    ]
}
